...
./mvnw package
```
It produces the `quarkus-reactive-kafka-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/quarkus-reactive-kafka-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/quarkus-reactive-kafka-1.0.0-SNAPSHOT-runner`
